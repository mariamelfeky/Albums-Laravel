<?php
    ...
    // Route::patch('/{admin}', [App\Http\Controllers\AdminUpdateController::class,'update'])->name('admin.update');
    ...
    //users 
    Route::get('/users', [App\Http\Controllers\AdminHomeController::class,'usersList'])->name('admin.users')->middleware('permitTo:ListUser');
    Route::delete('/users/{user}', [App\Http\Controllers\AdminHomeController::class,'deleteUser'])->name('user.delete')->middleware('permitTo:DeleteUser');
    //albums
    Route::get('/albums', [App\Http\Controllers\AdminHomeController::class,'albumsList'])->name('admin.albums')->middleware('permitTo:ListAlbums');
    Route::delete('/albums/{user}', [App\Http\Controllers\AdminHomeController::class,'deleteAlbum'])->name('album.delete')->middleware('permitTo:DeleteAlbums');
